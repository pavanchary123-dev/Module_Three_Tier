...
# # ─────────────────────────────
# module "frontend-ec2" {
# source = "../Root_Module/Frontend_LT"
# aws_region = "us-east-1"
...
# ─────────────────────────────
module "frontend_alb" {
source = "../Root_Module/LB_Frontend"
aws_region = "us-east-1"
vpc_id = module.vpc.vpc_id
...
module "asg-backend" {
source     = "../Root_Module/Backend_ASG"
...
module "asg-frontend" {
source     = "../Root_Module/Frontend_ASG"
